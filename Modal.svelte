<script>
	...
	*/
	...
	export let ModalVisible = "hidden";
	export let ModalLoading = false;
...
<div class="fixed flex inset-0 box-border !z-[1060] bg-slate-700 bg-opacity-80 {ModalBackdrop} {ModalVisible}"  on:click|self={() => hide()}>
